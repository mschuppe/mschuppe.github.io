...
basis of the growing text-corpus colline sur livre.
The recordings uploaded here document this process and give an insight into the work. They have the
character of field-recordings and do not claim to be finished pieces. Please listen with earphones.
Occasionally my reflections are supported by a thumbnail scetch to clarify my lines of thought.
