...
effect from below. In my current work I am searching a similar kind of transparency in 
the overlay of words and music. Therefore I keep the volume of my speaking and singing low.
...
In meiner Arbeit interessiert mich eine ähnliche Transparenz in der Überlagerung. 
