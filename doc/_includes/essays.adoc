...
[%hardbreaks]
english: icon:file[link=pdf/words-music-words.pdf]
deutsch: icon:file[link=pdf/Wörter-Musik-Wörter.pdf], erschienen in _improfil_, Theorie und Praxis improvisierter Musik, Nr. 83, Dezember 2020
