...
She has been a soloist with ensembles such as Klangforum Wien and Basel Sinfonietta. As a composer she developed projects with trained and untrained voices in public spaces, outdoors and indoors, often extending traditional concert format.
...
Seit Mitte der achtziger Jahre international tätig als Sängerin und Vokalistin mit Arbeitsfeld zeitgenössische Musik, Uraufführungen, solistische Tätigkeit (Klangforum Wien, Basel Sinfonietta, u.a.), Improvisation und interdisziplinäre Projekte. Als Komponistin
entwickelt sie Projekte mit Stimmen in öffentlichen Räumen, die oftmals das traditionelle Konzertformat erweitern.
