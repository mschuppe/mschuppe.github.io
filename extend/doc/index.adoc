...
singing, playing and listening, embedded in everyday life.
I am looking to connect with these ways of gathering in a form and with a mindset, which is suitable to
our time with diminishing resources and shifting challenges.
"Extending the idea of concert" in my practise is:

- developing performances with untrained as well as with trained voices and people with heterogeneous
backgrounds
- setting up stages outside expensively maintained concert halls, in semi-private, private or public spaces,
outdoors or indoors,
...
Zusammenkommens. Ereignisse und Momente des Singens, Spielens und Zuhörens, eingebettet in den
Alltag.
Ich suche nach Verbindungen zu dem Gestus dieser Zusammenkünfte, in einer Form und mit einer
Haltung, die unserer Zeit mit schwindenden Ressourcen und sich wandelnden Herausforderungen
entspricht.
"Extending the idea of concert" bedeutet für mich:

- Aufführungen mit Lai:innen ebenso wie mit ausgebildeten Stimmen sowie Menschen mit
unterschiedlichen Hintergründen zu entwickeln
- außerhalb kostspieliger Konzerthallen, in halbprivaten, privaten oder öffentlichen Räumen,
drinnen wie draußen, Bühnensituationen zu schaffen
- die Dauer über die gewohnte Konzertlänge hinaus auszudehnen oder zu verdichten
- den finanziellen und organisatorischen Aufwand durch radikal lokale Konzepte herunter zu
fahren
